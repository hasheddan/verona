...
if [ "$os" == "linux" ]; then
  ...
  # az vm image list --publisher Microsoft --offer WindowsServer --sku dotnetcode --output table --all
  image="MicrosoftWindowsServer:windowsserverdotnet:ws2019-dotnetcore-2-2:latest"
else
